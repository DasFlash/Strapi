...
export interface ApiAnimalAnimal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    alas: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    especie: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    viveEn: Schema.Attribute.Enumeration<['mar', 'tierra']>;
  };
}
...
export interface ApiClassClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adicionalInfo: Schema.Attribute.Component<'class.class-details', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    eventDetails: Schema.Attribute.Component<'event.event-details', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMaterialMaterial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<['video', 'document', 'url']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTeacherTeacher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adicionalInfo: Schema.Attribute.Component<'teacher.teacher-details', false>;
    classCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiTopicTopic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::topic.topic'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subtopic: Schema.Attribute.Component<'subtopic.subtopic', true>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
